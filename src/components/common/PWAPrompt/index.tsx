          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="mt-4 flex space-x-3" role="group" aria-label="PWA prompt actions">
                ...
                {promptType === 'install' && <button onClick={handleDismiss} className="flex-1 bg-white text-gray-700 px-4 py-2 text-sm font-medium border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" aria-label="Dismiss installation prompt">
                    Not Now
                  </button>}
              </div>
            </div>
