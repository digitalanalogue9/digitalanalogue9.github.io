  ...
  return (
    ...
    >
      ...
      >
        <h1 
          id="results-title"
          className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 lg:mb-8 text-gray-900"
        >
        ...
        <div 
          ...
          role="list"
          aria-label="Categories and values"
        >
            ...
            .map(([category, values]) => (
              ...
              >
                <h2 
                  ...
                  className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-800"
                >
                  {category}
                </h2>
                <div 
      ...
      <div 
        className="mt-6 sm:mt-8 lg:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4"
        role="group"
        aria-label="Result actions"
      >
        <button
          onClick={handlePrint}
          className="w-full sm:w-auto px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        ...
        <Link
          ...
          className="w-full sm:w-auto px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-center focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
