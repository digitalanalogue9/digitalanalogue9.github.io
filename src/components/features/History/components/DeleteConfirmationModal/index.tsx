    ...
    >
      <div className="space-y-4">
        ...
        {!isDeleting && sessionCount > 0 && (
          <div className="mt-4 bg-gray-50 rounded-md p-4 max-h-48 overflow-y-auto">
        ...
        <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
          ...
          <button
            type="button"
            className="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-800 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm disabled:opacity-50"
            onClick={onClose}
            disabled={isDeleting}
          >
            Cancel
