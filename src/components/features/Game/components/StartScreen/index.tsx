    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <form onSubmit={e => {
        ...
        <div className="flex gap-3 sm:gap-4 items-center">
          ...
          <button type="submit" className="px-4 sm:px-8 py-2 sm:py-3 bg-blue-700 text-white font-medium rounded-md hover:bg-blue-800 transition-colors duration-200 shadow-sm text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2" aria-label="Begin the core values exercise">
            Start Exercise
          </button>
        </div>
      </form>
