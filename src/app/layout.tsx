      ...
      <body className="bg-gray-100">
        <MobileProvider>
          <div className="flex min-h-screen flex-col">
            {/* Header */}
            <header className="flex-shrink-0 bg-blue-700 text-white shadow-md" role="banner" aria-label="Site header">
            ...
            {/* Main content */}
            <main
              className="flex flex-1 flex-col md:overflow-hidden" // Only hide overflow on desktop
              role="main"
            ...
            {/* Footer */}
            <footer
              className="bg-blue-700 text-white md:flex-shrink-0" // Only shrink on desktop
              role="contentinfo"
              aria-label="Site footer"
            >
              <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 text-sm text-white sm:px-6 lg:px-8">
                <span>
