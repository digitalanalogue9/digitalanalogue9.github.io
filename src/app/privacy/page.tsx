  ...
  return (
    <div className={`max-w-4xl ${getContainerClassName(isMobile)}`} aria-labelledby="privacy-policy-heading">
      ...
      <section aria-labelledby="introduction-heading" className="pt-2">
        <h2 id="introduction-heading" className={`${styles.subheading} pb-2 text-center font-bold text-black`}>
      ...
      <section aria-labelledby="application-data-heading" className="pt-2">
        <h2 id="application-data-heading" className={`${styles.subheading} pb-2 text-center font-bold text-black`}>
        ...
        <div className={`rounded-lg border border-gray-100 bg-blue-100 p-4 shadow-sm ${styles.prose} text-black`}>
          <p className={`${styles.paragraph} text-black`}>
            Data is all stored locally on your device and is never transmitted to our servers. You can choose to export
            your data to a file if you wish to keep a copy of your sessions.
          </p>
        </div>
      </section>

      <section aria-labelledby="google-analytics-heading" className="pt-2">
        <h2 id="google-analytics-heading" className={`${styles.subheading} pb-2 text-center font-bold text-black`}>
        ...
        <div className={`rounded-lg border border-gray-100 bg-green-100 p-4 shadow-sm ${styles.prose} text-black`}>
          <p className={`${styles.paragraph} text-black`}>
            We use Google Analytics to understand how users interact with our app. No personally identifiable
            information (PII), such as names or email addresses, is collected. Any data collected is anonymised and
          ...
          <p className={`${styles.paragraph} text-black`}>Specifically, we track anonymous usage data, such as:</p>
          <ul className={`list-disc pl-6 text-black ${styles.paragraph}`}>
            <li>Pages viewed</li>
      ...
      <section aria-labelledby="data-retention-heading" className="pt-2">
        <h2 id="data-retention-heading" className={`${styles.subheading} pb-2 text-center font-bold text-black`}>
      ...
      <section aria-labelledby="consent-management-heading" className="pt-2">
        <h2 id="consent-management-heading" className={`${styles.subheading} pb-2 text-center font-bold text-black`}>
        ...
        <div className={`rounded-lg border border-gray-100 bg-blue-100 p-4 shadow-sm ${styles.prose} text-black`}>
          ...
          <p className={`${styles.paragraph} mt-4 text-black`}>To adjust your preferences, use the button below:</p>
      ...
      <section aria-labelledby="contact-heading" className="pt-2">
        <h2 id="contact-heading" className={`${styles.subheading} pb-2 text-center font-bold text-black`}>
